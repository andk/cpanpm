...
=item * CPAN, CPAN::Reporter, CPAN::Reporter::Smoker

=item * CPANPLUS, CPAN::YACSmoke, POE::Component::CPAN::YACSmoke

=back

=head1 Warum teste ich?

Um Bugs zu finden, bevor ich sie als Enduser finde.
...
developers and here were are, seeing the EXACT same thing.
